...
The Ljung-Box test is statistical test that is often conducted in order to test for autocorrelation in a time series for different lags \citep{Hyndman}. The reader is referred to \cite{Hyndman} for a detailed description of the test. The Durbin-Watson test is another test frequently conducted in order to test for the presence of autocorrelation at lag 1 \citep{Carol_1}. A detailed description of the test may for instance be found in \cite{Carol_1}.
