...
More quantitative approaches could be to use the financial metric, Sharpe Ratio \cite{Sharpe}. Another interesting approach could be to model it as the Secretary Problem
